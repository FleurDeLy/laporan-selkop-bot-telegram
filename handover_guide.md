# SELKOP Bot (Sistem Laporan Tugas Kebersihan) — IT Handover Guide

## System Architecture (Big Picture)
This document is the **single source of truth** for the SELKOP Telegram Bot architecture. 

> **Business Purpose:** Bot ini secara spesifik dibangun untuk mengotomatisasi distribusi, pelaporan, dan rekapitulasi **Tugas Kebersihan (Cleaning Tasks)** di seluruh outlet Selkop. Sistem ini memastikan setiap area dibersihkan sesuai standar operasional (seperti General Cleaning Area, Cek Travel Path, dan Isi Ceklis Kebersihan) dengan mewajibkan pelaporan foto real-time setiap pergantian shift (4 jam).
